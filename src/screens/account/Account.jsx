        ...
        <div className="w-full  h-full px-10 pt-6 pb-10 bg-white rounded-lg shadow-sm">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <button
              ...
              className="bg-[#002D62] text-white px-4 py-2 rounded-full text-sm flex items-center gap-2 hover:bg-[#001f47] transition"
            >
          ...
          <ul className="flex flex-col gap-4 m-0 p-0 list-none">
            ...
            <li>
              <button
                ...
                className="flex items-center justify-between px-4 py-3 rounded-lg border border-red-200 bg-red-50 text-red-600 hover:bg-red-100 transition-all w-full"
              >
                <div className="flex items-center gap-3">
                  <img
                    src={logoutIcon}
